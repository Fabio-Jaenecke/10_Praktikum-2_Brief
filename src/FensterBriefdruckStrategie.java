...
/**Legt die Strategie für Fensterbreifdrucke fest.
 * 
 * 
...
public class FensterBriefdruckStrategie implements Briefdruckstrategie {
	...
	/**Erstellt den Einzelbrief mit Fenster Brief Formatierung.
	 * 	 * 
	 * @param brief Ein Einzelner Brief
	 */
	public FensterBriefdruckStrategie(Brief brief) {
		einzelBrief = brief;
	}
	
	/**Erstellt Serienbrief mit Fenster Brief Formatierung.
	 * 
	 * @param briefe Mehrere Briefe als Liste
	 */
	public FensterBriefdruckStrategie(ArrayList<Brief> briefe) {
		this.briefe = briefe;
	}
	...
	public String emailEmpfaengerBlock() {
		...
		empfaengerBlock.append("\t\t\t\t\t\t\t\t\t").append(empfaenger.getVorname()).append("\n");
		empfaengerBlock.append("\t\t\t\t\t\t\t\t\t").append(empfaenger.getNachname()).append("\n");
		empfaengerBlock.append("\t\t\t\t\t\t\t\t\t").append(empfaenger.getStrasse() + " " + empfaenger.getHausnummer()).append("\n");
		empfaengerBlock.append("\t\t\t\t\t\t\t\t\t").append(empfaenger.getPlz() + " " + empfaenger.getOrt()).append("\n");
	...
	public String emailHauptBlock() {
		...
		hauptBlock.append("\n\n").append(inhalt.getDatum().getTime()).append("\n\n");
